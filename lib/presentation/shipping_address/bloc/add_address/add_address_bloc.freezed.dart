...
class _$AddAddressImpl implements _AddAddress {
  ...
  @override
  String toString() {
    return 'AddAddressEvent.addAddress(name: $name, address: $address, phone: $phone, provId: $provId, cityId: $cityId, subdistrictId: $subdistrictId, provinceName: $provinceName, cityName: $cityName, subdistrictName: $subdistrictName, codePos: $codePos, userId: $userId, isDefault: $isDefault)';
  }
